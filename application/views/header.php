...
And, for the designers, we offer a free PSD Download. It provides a faster, easier and less repetitive way for web developers or designers to create elegant web apps.">
    <link rel="shortcut icon" href="<?php echo base_url() ?>asset/vendor/bootflat/favicon_16.ico"/>
    <link rel="bookmark" href="<?php echo base_url() ?>asset/vendor/bootflat/favicon_16.ico"/>
    <!-- site css -->
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/vendor/bootflat/css/site.min.css">
    ...
    <![endif]-->
    <script type="text/javascript" src="<?php echo base_url() ?>asset/vendor/bootflat/js/site.min.js"></script>
  </head>